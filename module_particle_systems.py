...
##### Dungeon Water Drops  END #####
    ...
    ("adimi_tool_tp_symbol", psf_always_emit|psf_billboard_2d|psf_global_emit_dir, "peasant_a",
     100, 0.05, 0.0, 0.0, 100.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.7), (1.0, 0.7),          #alpha keys
     (0.0, 255), (1.0, 255),      #red keys
     (0.0, 255), (1.0, 255),       #green keys
     (0.0, 0.0), (1.0, 0.0),      #blue keys
     (0, 1),    (1.0, 1.0),        #scale keys
     (0.0, 0.0, 0.0),           #emit box size

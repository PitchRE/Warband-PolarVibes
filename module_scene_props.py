...
#  ("Baggage",sokf_place_at_origin|sokf_entity_body,"package","bobaggage"),
  ...
  ("door_destructible",sokf_moveable|sokf_show_hit_point_bar|sokf_destructible|spr_use_time(2),"tutorial_door_a","bo_tutorial_door_a", [
    ...
    [
	  ...
	  (prop_instance_get_variation_id, ":vardoor",":instance_id"),
      (try_begin),
	    (eq,"$adimi_tool_hungergames",0),
	    #for only server itself-----------------------------------------------------------------------------------------------
        (call_script, "script_use_item", ":instance_id", ":agent_id"),
        #for only server itself-----------------------------------------------------------------------------------------------
        (get_max_players, ":num_players"),                               
	  ...
	  (else_try),
		...
		(try_end),
		(scene_prop_get_num_instances, ":num_instances_of_scene_prop", "spr_barrier_capsule"),
        (try_for_range, ":cur_prop_instance", 0, ":num_instances_of_scene_prop"),
         (scene_prop_get_instance, ":prop_instance_id", "spr_barrier_capsule", ":cur_prop_instance"),
		...
		# (add_missile,":shooter_agent", pos1, ":missile_speed", "itm_nomad_bow", 0,"itm_bodkin_arrows", 0),
		# (add_missile,":shooter_agent", pos1, ":missile_speed", "itm_jarid", imod_deadly,"itm_jarid", imod_deadly),
        (try_end),
    ...
    [
	  ...
	  (eq,":var",1),
	  (scene_prop_set_hit_points, ":instance_id", 99999999),	#31-03-2015 repair after each use
      (agent_is_active,":agent_id"),
	  (agent_is_alive,":agent_id"),
	  (agent_get_player_id,":pid",":agent_id"),
	  (player_is_active,":pid"),
	  (try_begin),
	    (player_slot_eq,":pid",adimi_tool_player_next_hungergame,0),
		(try_begin),
			(call_script,"script_adimi_tool_hungergames_count_signed_players"),
			(lt,reg1,"$adimi_tool_hungergames_possible_players"),
			(player_set_slot,":pid",adimi_tool_player_next_hungergame,1),
			(assign,":stop",0),
			(try_for_prop_instances, ":prop_instance_id", "spr_wood_a", somt_object), # if object_id and object_type is not given, it loops through all instances.
				(eq,":stop",0),
				(prop_instance_get_variation_id, ":var",":prop_instance_id"),
				(eq,":var",1),
				(scene_prop_slot_eq,":prop_instance_id",adimi_tool_hunger_spawn_point,0),
				(scene_prop_set_slot,":prop_instance_id",adimi_tool_hunger_spawn_point,1),#spawn point is now used
				(player_set_slot,":pid",adimi_tool_hungergames_spawn_scene_prob_id,":prop_instance_id"),
				(assign,":stop",1),#stop...
			(try_end),
			(multiplayer_send_string_to_player,":pid",multiplayer_event_show_server_message,"str_adimi_tool_hungergames_player_sign_up_in"),
			(agent_set_speed_modifier,":agent_id", 40),
		(else_try),
			(multiplayer_send_string_to_player,":pid",multiplayer_event_show_server_message,"str_adimi_tool_hungergames_player_cannot_sign_up"),
	    (try_end),
	  (else_try),
	    (player_slot_eq,":pid",adimi_tool_player_next_hungergame,1),
		(player_set_slot,":pid",adimi_tool_player_next_hungergame,0),
		#Gotha new spawn system for a better performance 04-04-2015 23:11
		(try_begin),
			(player_get_slot,":prop_instance_id",":pid",adimi_tool_hungergames_spawn_scene_prob_id),
			(prop_instance_is_valid,":prop_instance_id"),
			(scene_prop_set_slot,":prop_instance_id",adimi_tool_hunger_spawn_point,0),
		(try_end),
		#Better spawn system end
		(multiplayer_send_string_to_player,":pid",multiplayer_event_show_server_message,"str_adimi_tool_hungergames_player_sign_up_out"),  
   ...
   (ti_on_init_scene_prop,
    [
	  ...
	  (try_begin),
		(multiplayer_is_server),
		(eq,"$adimi_tool_hungergames",1),
		(scene_prop_set_hit_points, ":instance_no", 99999999),	
	  (try_end),
    ]),
  ...
  ("archery_target_with_hit_a",0,"arena_archery_target_a","bo_arena_archery_target_a", [#Adimi Tool
 ...
 (ti_on_scene_prop_init,#testmove mit archerytarget_move ersetzt # done
	...
	(multiplayer_is_server),
      (store_trigger_param_1, ":instance_id"),
	   ...
	   (prop_instance_get_variation_id,":var_1", ":instance_id"),#move geschwindigkeit in sekunden
	   (prop_instance_get_variation_id_2,":var_2", ":instance_id"),#Move reichweite in metern
	   (neq,":var_1",0),
	   (neq,":var_2",0),
	   (store_mul,":seconds",100,":var_1"),
	   (store_mul,":meterp",100,":var_2"),
	   (store_mul,":meter2",2,":meterp"),
	   (store_sub,":meterm",":meterp",":meter2"),
       (position_move_x, pos6, ":meterm"),                    
       (scene_prop_set_slot, ":instance_id", adimi_tool_archery_target , 1),	   
       (prop_instance_animate_to_position, ":instance_id", pos6, ":seconds"),
    ]),
...
(ti_on_scene_prop_animation_finished, [
    ...
    (try_begin),
	    (prop_instance_get_position, pos6, ":instance_id"),
	    (scene_prop_slot_eq, ":instance_id", adimi_tool_archery_target , 1),
        (position_move_x, pos6, ":meterp"),                       
        (scene_prop_set_slot, ":instance_id", adimi_tool_archery_target , 2), 
        (prop_instance_animate_to_position, ":instance_id", pos6, ":seconds"),
	(else_try),
	    (prop_instance_get_position, pos6, ":instance_id"),
		(scene_prop_slot_eq, ":instance_id", adimi_tool_archery_target , 2),
        (position_move_x, pos6, ":meterm"),                  
        (scene_prop_set_slot, ":instance_id", adimi_tool_archery_target , 1), 
        (prop_instance_animate_to_position, ":instance_id", pos6, ":seconds"),
    (try_end),
    ...
    [
        ...
        (store_trigger_param_1, ":instance_no"),
		 ...
		 (str_store_string, s1, "str_adimi_archery_target_hit"),
...
(ti_on_scene_prop_use,
    ...
    (store_trigger_param_1, ":agent_id"),
    (store_trigger_param_2, ":instance_id"),
    (call_script,"script_cf_adimi_tool_teleport_door",":agent_id",":instance_id"),
  ]),
   (ti_on_init_scene_prop,
    [
      (store_trigger_param_1, ":instance_no"),
  ...
  ("grate",sokf_moveable,"grate","bograte", []),#Added sokf_moveable adimitools
  ("jug",0,"jug","0", []),
  ("potlamp",0,"potlamp","0", []),
  ...
  ("windmill_fan_turning",sokf_moveable,"windmill_fan_turning","bo_windmill_fan_turning", [#Adimi Tool
  
  (ti_on_scene_prop_init,
    [
      (store_trigger_param_1, ":instance_id"),
	  (prop_instance_is_valid,":instance_id"),
      (call_script,"script_cf_adimi_tool_rotate_windmil_fan",":instance_id"),
    ]),
  (ti_on_scene_prop_animation_finished, [
    (store_trigger_param_1, ":instance_id"),
	(prop_instance_is_valid,":instance_id"),
...
##    ]),     
  ...
  (ti_on_scene_prop_hit,
	...
	(store_trigger_param,":instance_id",1),
      (try_begin),
        (multiplayer_is_server),
        (prop_instance_get_variation_id, ":can_heal",":instance_id"),
        (prop_instance_get_variation_id_2,":hp_addition",":instance_id"),
		(eq,":can_heal",1),
		(gt,":hp_addition",0),
		(try_begin),
		  (gt,":hp_addition",100),
		  (assign,":hp_addition",100),
		(try_end),
		(set_fixed_point_multiplier, 1),
		...
		(lt,":hp",100),
		(val_add,":hp",":hp_addition"),
		(try_begin),
		  (gt,":hp",100),
		  (assign,":hp",100),
		(try_end),
		(agent_set_hit_points,":agent",":hp",0),
		(assign,reg1,":hp_addition"),
		(multiplayer_send_string_to_player, ":player", multiplayer_event_show_server_message, "str_adimi_hit_bed"),	
      (try_end), 
    ]),
  ]),
  ...
  (ti_on_scene_prop_hit,
	...
	(store_trigger_param,":instance_id",1),
      (try_begin),
		...
		(try_begin),
		  (ge, ":weapon", 0),
		  (item_get_type, ":typ", ":weapon"),
		  (neq,":typ",itp_type_thrown),
		  (neq,":typ",itp_type_bow),
		  (neq,":typ",itp_type_crossbow),
		  (neq,":typ",itp_type_pistol),
		  (neq,":typ",itp_type_musket),
		  (assign,":continue",1),
		(else_try),
		  (lt,":weapon",0),
		  (assign,":continue",1),
  ...
  ("draw_bridge_a",sokf_moveable,"draw_bridge_a","bo_draw_bridge_a", [
  (ti_on_scene_prop_hit,
    [ 
	 # (store_trigger_param,":instance_id",1),
      (try_begin),
        (multiplayer_is_server),
		#(prop_instance_play_sound,":instance_id", "snd_dummy_hit"),
        (particle_system_burst, "psys_dummy_smoke", pos1, 3),
        (particle_system_burst, "psys_dummy_straw", pos1, 10),
      (try_end),      
    ]),
  ]),#AdimiTools added sokf_moveable
  ...
  ("winch_b",sokf_moveable|spr_use_time(5),"winch_b","bo_winch", [
   (ti_on_scene_prop_use,
    [
      ...
      (store_trigger_param_2, ":instance_id"),
	  #Adimi Tool
      (call_script, "script_cf_adimi_tool_admin_winch", ":instance_id", ":agent_id"),

	  #Adimi Tool End (If admin winch) Admin winch = var1 = 1
	 #  (try_begin),
	 #   (agent_is_active,":agent_id"),
	 #   (agent_is_alive,":agent_id"),
	...
	#	(agent_get_player_id,":pid",":agent_id"),
	##	(player_is_active,":pid"),
    #    (str_store_player_username,s2,":pid"),
	#	(scene_prop_get_slot,reg1,":instance_id",scene_prop_open_or_close_slot),#1=open 0=close
	#	(get_max_players,":max"),
	#	(try_for_range,":player",0,":max"),
    #      (player_is_active,":player"),
	#	  (player_get_team_no,":team",":player"),
	#	  (eq,":team",0),
	#	  (multiplayer_send_string_to_player, ":player", multiplayer_event_show_server_message, "str_adimi_open_close_gate_done"),
	#    (try_end),
	#   (try_end),
    ]),
	(ti_on_scene_prop_start_use,
    [
	  ...
	  (try_begin),
		...
		(player_is_active,":pid"),
		(scene_prop_get_slot,reg1,":instance_id",scene_prop_open_or_close_slot),#1=open 0=close
		(multiplayer_send_string_to_player, ":pid", multiplayer_event_show_server_message, "str_adimi_start_open_close_gate"),
	  (try_end),
    ]),
  ]),
...
#Gotha Weather Scene Probs
#("environment_daytime", sokf_invisible,"question_mark","0",[]), 
#("environment_rainfall", sokf_invisible,"question_mark","0",[ ]), 
#("environment_clouds", sokf_invisible,"question_mark","0", [ ]), 
#("environment_haze", sokf_invisible,"question_mark","0", [ ]), 

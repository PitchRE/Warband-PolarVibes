...
pitch_mp_cheer = ( 
 0, 0, 5, [(key_clicked, key_c)], 
 [
   (multiplayer_get_my_player, ":player"), # Get player info

(multiplayer_send_int_to_server, multiplayer_event_pitch_tools, adimi_tool_cheer), ### cheer
   (display_message, "@ action cheer"),
 ])


pitch_mp_dance = ( 
 0, 0, 5, [(key_clicked, key_b)], 
 [
   (multiplayer_get_my_player, ":player"), # Get player info

(multiplayer_send_int_to_server, multiplayer_event_pitch_tools, adimi_tool_dance), ### dance
  # (display_message, "@ action dance"),
 ])



pitch_mp_taunt = ( 
 0, 0, 5, [(key_clicked, key_v)], 
 [

(multiplayer_send_int_to_server, multiplayer_event_pitch_tools, adimi_tool_taunt), ### taunt
 #  (display_message, "@ action taunt"),
 ])

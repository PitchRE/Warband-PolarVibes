...
adimi_tool_cheer = 26 ### cheer //
adimi_tool_taunt = 27 ### taunt //
adimi_tool_dance = 28 ### taunt //
...
player_uid_limit_until_sub = 1000000 
player_uid_limit = player_uid_limit_until_sub 
player_uid_limit_sub = 900000

#Player Slots
#02:58 15.09.2013 ENL STREAMER STUFF
slot_player_is_streamer                        = 40

adimi_tool_rdy_for_respawning = 50 
adimi_tool_rdy_for_hungergames_respawning   = 51 
adimi_tool_respawning_hp   = 52 
adimi_tool_respawn_x          = 53 
adimi_tool_respawn_y          = 54 
adimi_tool_respawn_z          = 55 
adimi_tool_player_player_selected_limited_class   = 56 


adimi_tool_admin_level_low   = 57 #Temp. Ban, Mute for all, Kick Players, GameId, AdminChat, Intern AdminChat, 
adimi_tool_admin_level_mid   = 58 #Temp. Ban, Perm. Ban, Administration Panel, Mute for all, Kick Players, GameId, AdminChat, Intern AdminChat, Slay players
adimi_tool_admin_level_high   = 59 #Temp. Ban, Perm. Ban, Administration Panel, Mute for all, Kick Players, GameId, AdminChat, Intern AdminChat, Slay players, Teleport, Switch Teams, Spawn Items, SetHp, SetGold, Restore ammo heal shield

#Player Hungergame Slots
adimi_tool_player_next_hungergame   = 60
adimi_tool_player_is_in_hungergame   = 61

adimi_tool_hungergames_spawn_scene_prob_id          = 62 
#the following is outdated... removed caused to performacne issues
#adimi_tool_hungergames_x_correction          = 62 
#adimi_tool_hungergames_y_correction        = 63 
#adimi_tool_hungergames_z_correction         = 64

#Agent Slots
adimi_tool_stray_horse          = 50 #set last mission timer


#Scene Prop Slot
adimi_tool_windmill = 50
adimi_tool_archery_target = 51
adimi_tool_hunger_spawn_point = 52
adimi_tool_hunger_trap_triggered = 53

adimi_tool_already_joined_01  = "trp_join_leave_01"
adimi_tool_already_joined_02  = "trp_join_leave_02"
adimi_tool_tk_kick_warning_01 = "trp_teamkill_stats_01"
adimi_tool_tk_kick_warning_02 = "trp_teamkill_stats_02"
adimi_tool_tk_kick_amount_01  = "trp_teamkill_stats_03"
adimi_tool_tk_kick_amount_02  = "trp_teamkill_stats_04"

#Event for Streamer Stuff
enl_event_toggle_streamer         =  6 #S  1 player; C 2 player value 03:08 15.09.2013

#Server Events
adimi_tool_kill = 1 #done  player_list_action_type 9
adimi_tool_heal = 2#done  player_list_action_type 8
adimi_tool_godmode = 3#done  player_list_action_type 12
adimi_tool_gold = 4#done  player_list_action_type 10
adimi_tool_gameid = 5#done  player_list_action_type 13
adimi_tool_sound = 6#passiv
adimi_tool_animation = 7#passiv
adimi_tool_mute = 8#done  player_list_action_type 7
adimi_tool_admin_set_poll = 9#done
adimi_tool_chat = 10#passiv
adimi_tool_admin_chat = 11#passiv
adimi_tool_spawn_item = 12#done  player_list_action_type 11
adimi_tool_spawn_horse = 13#done  player_list_action_type 11
adimi_tool_restore_ammo_shield = 14#done  player_list_action_type 14
adimi_tool_slay_bots = 15#done 
adimi_tool_slay_horse = 16#done
adimi_tool_switch_team = 17 #done  player_list_action_type 15
adimi_tool_teleport = 18 #done  player_list_action_type 16 & 17
adimi_tool_request_custom_teleport = 19 #done
adimi_tool_force_teambalance = 20 #teambalance directly
adimi_tool_spawn_mof = 21 #spawns master of the field flag instantly 
adimi_tool_admin_speed_hack = 22 #Admin speedhack
adimi_tool_request_map_reset = 23 #Map reset
adimi_tool_freeze = 24 #Frezzzzeee
adimi_tool_total_fix = 25 #Heal player&horse&bots, refill ammo, fix shields


#Client Events (variable sync...etc.)
adimi_tool_teamkill_options = 1 #Syncs teamkill options
adimi_tool_server_message_options = 2 #Server message options
adimi_tool_drowning_options = 3 #Drowning options
adimi_tool_join_message_options = 4 #Join message
adimi_tool_leave_message_options = 5 #Leave Message
adimi_tool_horses_are_avaliable = 6 #Horses
adimi_tool_duel_armor = 7 #Duel armors
adimi_tool_agent_kicking = 8 #Agent kicking
adimi_tool_crash_server = 9 #Crash server...
adimi_tool_rainfall = 10 #Rainfall sync...
adimi_tool_horses_fade_out = 11 #stray horses
adimi_tool_class_limit_inf = 12 #Class limit infanty
adimi_tool_class_limit_archer = 13 #Class limit archer
adimi_tool_class_limit_cav = 14 #Class limit cav
adimi_tool_set_admin_level = 15 #Admin Level
adimi_tool_wnl_mof = 16 #WNL/ENL Master of the Field after 2min
adimi_tool_no_weapons_shields = 17 #Agents can't spawn with weapons or shields
adimi_tool_mute_loop = 18 #Toggle mute mutes all players all 10seconds
adimi_tool_immortal_loop = 19 #Toggle immortal loop
adimi_tool_team_switch_after_round = 20 #Toggle team switch after round
adimi_tool_class_limit_filter_typ = 21 #Class limit typ filer 
adimi_tool_switch_after_x_rounds = 22 #Switch teams after... rounds
adimi_tool_hungergames = 23 #Switch teams after... rounds




adimi_tool_custom_scene_begin = "scn_multi_custom_adimi_tool_scene_1"

adimi_tool_server_message_1 = "str_custom_server_message_1"
adimi_tool_server_message_2 = "str_custom_server_message_2"
adimi_tool_server_message_3 = "str_custom_server_message_3"
adimi_tool_server_message_4 = "str_custom_server_message_4"
adimi_tool_server_message_5 = "str_custom_server_message_5"
